...
#define STRIP_TYPE                    NEO_GRBW //NEO_GRBW for RGBW strip
...
#define ENABLE_BLUETOOTH               false  // Set to true if this arduino is using bluetooth, otherwise set to false so bluetooth code does not run
